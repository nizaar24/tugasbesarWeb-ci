...
<nav class="navbar navbar-inverse">
         <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse navbar-ex1-collapse">
            ...
            <li>
            <a class="nav-link" href="<?php echo base_url('index.php/Item') ?>">Item<span class="sr-only">(current)</span></a>
            </li>
            <li><a class="nav-link" href="<?php echo base_url('index.php/User_c') ?>">Data User<span class="sr-only">(current)</span></a>
            </li>
            <li><a class="nav-link" href="<?php echo base_url('index.php/dataTransaksi') ?>">transaksi<span class="sr-only">(current)</span></a>
            </li>
